# Unattended run evidence — `delivery-engine-readiness-2026-08-11`
...
| Item | Value |
| --- | --- |
| Run ID | `delivery-engine-readiness-2026-08-11` |
| Started | `2026-08-11T05:42:59.345887477Z` |
| Journal records at the time of writing | 34 |
| Worktree | `/mnt/d/Development/corsolv-delivery-engine` |
| Branch | `corsolv/p2-gascity-main-reconcile` |
| HEAD before this commit | `80967f440538897e9a1211afaec02ff526766a59` |
...
```json
{
  ...
  "startedAt": "2026-08-11T05:42:59.350909615Z",
  "updatedAt": "2026-08-11T05:48:22.254002799Z",
  "elapsed": "5m23s",
  "lastMilestone": "regress-api succeeded",
  ...
  "writerOwner": "delivery-engine-readiness-2026-08-11",
  "writerPid": 918716,
  "worktree": "/mnt/d/Development/corsolv-delivery-engine",
  "branch": "corsolv/p2-gascity-main-reconcile",
  "head": "80967f440538897e9a1211afaec02ff526766a59",
  "tasks": {
    "failed": 1,
    "held": 1,
    "pending": 2,
